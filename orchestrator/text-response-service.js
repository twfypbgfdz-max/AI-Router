...
function routeName(taskType, intent) {
  ...
  if (["learning", "obsidian"].includes(taskType) || ["general_question", "explanation", "project_status_summary", "project_status_report", "knowledge_answer", "snapshot_briefing"].includes(intent)) return "knowledge_query";
  return "general_chat";
}
