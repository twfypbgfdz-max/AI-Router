...
export const ERROR_CODES = Object.freeze(["INVALID_REQUEST", "UNSUPPORTED_SCHEMA_VERSION", "VALIDATION_FAILED", "INVALID_TASK", "PAYLOAD_TOO_LARGE", "ADAPTER_NOT_ALLOWED", "MODE_NOT_ALLOWED", "ACTION_NOT_ALLOWED", "ACTION_NOT_ALLOWLISTED", "EXECUTION_DISABLED", "ORIGIN_NOT_ALLOWED", "ROUTE_NOT_FOUND", "TIMEOUT", "UNAVAILABLE", "APPROVAL_REQUIRED", "APPROVAL_INVALID", "RUN_NOT_FOUND", "RUN_ALREADY_FINISHED", "ADAPTER_FAILED", "STEP_FAILED", "STEP_TIMEOUT", "WORKING_DIRECTORY_NOT_ALLOWED", "READ_ONLY_VIOLATION_DETECTED", "CODEX_CLI_NOT_FOUND", "CODEX_CLI_UNSUPPORTED", "CODEX_PROCESS_START_FAILED", "INTERNAL_ERROR",
...
export const ALLOWED_CAPABILITIES = Object.freeze(["analysis", "planning", "coding", "debugging", "architecture", "review", "writing", "summarization", "research-planning", "synthesis", "classification"]);
